  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '20px', background: '#111', minHeight: '100vh' }}>
      <h1 style={{ color: '#C2883A', textAlign: 'center', fontSize: '3em', marginBottom: '40px' }}>About BogartFashion - Men's Wear</h1>
             ...
             <div style={{ display: 'flex', gap: '40px', alignItems: 'stretch', marginTop: '30px' }}>
         <div style={{ flex: 1 }}>
         ...
         <div style={{ flex: 1, display: 'flex', alignItems: 'stretch' }}>
           <img 
             src="http://localhost:3001/uploads/formal-wear/black-suit.jpg" 
             alt="About BogartFashion - Premium Men's Formal Wear" 
             style={{ 
               width: '100%', 
               height: '100%',
               objectFit: 'cover',
               borderRadius: '8px',
               boxShadow: '0 4px 20px rgba(194, 136, 58, 0.3)',
